...
<label for="nom" style="color:#734d1f;">Name</label>
<div class="form-floating mb-3">
    <input type="text" class="form-control" name="nom" id="nom" placeholder="Ex: Simon">
    
</div>

<label for="email" style="color:#734d1f;">Email</label>
<div class="form-floating mb-3">
    <input type="text" class="form-control" name="email" id="email" placeholder="Ex: glain@gmail.com">
