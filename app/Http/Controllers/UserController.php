...
class UserController extends Controller
{
    ...
    public function store(StoreUserRequest $request)
    {
        ...
        return to_route("user.index")->with('success', 'User saved with success !');
    }
    ...
    public function update(Request $request, User $user)
    {
        ...
        $user->save();
        return to_route('user.index')->with('success', 'User updated with success!');
    }
    ...
    {
        $user->delete();
        return back()->with('success', 'User deleted with success !');
    }
